...
<body>
	<center>	<table width="500"  bgcolor="" border="1">
		...
		<tr width="500"  height="20"> 
			...
			<tr>
				<td width="150" height="20"><h3 style ="text-align:center"><font color="#009900"> Mesaj Kaydedilirken Hata Oluştu !!!	</td>
			...
			<tr>
				...
				<td width="150" height="20"><p style="color:red; text-align:center"> Forma Geri Dönmek İçin<a href="yaz.php">  Buraya Tıklayınız </p></a></td>
			</tr>
			<tr>
				</table></center></td>
