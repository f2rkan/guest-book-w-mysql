...
<body>
	<center>	<table width="500"  bgcolor="" border="0">
		...
		<tr width="500"  height="20"> 
			...
			<tr>
				<td width="150" height="20"><h3 style ="text-align:center"><font color="#009900"> Mesajınız Başarıyla Kaydedildi.	</td>
			...
			<tr >
				<td width="150" height="20"> <p style="color:red" align="center">Mesajınız Yönetici Tarafından Kontrol Edildikten Sonra Yayınlanacaktır</p></td>
				
			</tr>
			<tr>
				 <td width="150" height="20"><p style="color:red; text-align:center"> Forma Geri Dönmek için<a href="yaz.php">  Buraya Tıklayınız </p></a></td>
			</tr>
